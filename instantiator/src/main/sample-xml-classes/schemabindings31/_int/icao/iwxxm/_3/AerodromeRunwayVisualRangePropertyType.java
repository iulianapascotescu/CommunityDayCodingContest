...
@XmlSeeAlso({
	schemabindings31._int.icao.iwxxm._3.MeteorologicalAerodromeObservationType.Rvr.class
})
public class AerodromeRunwayVisualRangePropertyType {
    ...
    public boolean isSetAerodromeRunwayVisualRange() {
        return (this.aerodromeRunwayVisualRange!= null);
    }
