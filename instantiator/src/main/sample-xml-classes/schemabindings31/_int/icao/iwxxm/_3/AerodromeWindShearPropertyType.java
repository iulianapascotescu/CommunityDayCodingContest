...
@XmlSeeAlso({
	schemabindings31._int.icao.iwxxm._3.MeteorologicalAerodromeObservationType.WindShear.class
})
public class AerodromeWindShearPropertyType {
    ...
    public boolean isSetAerodromeWindShear() {
        return (this.aerodromeWindShear!= null);
    }
