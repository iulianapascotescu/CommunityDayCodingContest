...
@XmlSeeAlso({
	schemabindings31._int.icao.iwxxm._3.MeteorologicalAerodromeObservationType.RunwayState.class
})
public class AerodromeRunwayStatePropertyType {
    ...
    public boolean isSetAerodromeRunwayState() {
        return (this.aerodromeRunwayState!= null);
    }
